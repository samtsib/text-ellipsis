...
namespace spaceellipsis\textellipsis;

use spaceellipsis\textellipsis\twigextensions\TextEllipsisTwigExtension;
 ...
 *
 */
class TextEllipsis extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new TextEllipsisTwigExtension());
